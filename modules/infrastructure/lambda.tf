...
resource "aws_lambda_function" "lambda" {
  ...
  filename         = each.value.s3_bucket == null ? data.archive_file.lambda[each.key].output_path : null
  ...
  source_code_hash = each.value.s3_bucket == null ? data.archive_file.lambda[each.key].output_base64sha256 : null
